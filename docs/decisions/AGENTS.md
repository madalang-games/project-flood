...
|------|------|--------|---------|
| `ADR-001-gimmick-cells-removed-items-only.md` | 2026-06-04 | accepted | Bomb/HRocket: board cells removed, items only (VRocket ref → ADR-007) |
...
| `ADR-007-item-set-v2-vrocket-removed-new-items-added.md` | 2026-06-06 | accepted | VRocket removed; ColorSweep/RowShift/CellSwap added; item set now 5 |
