# ADR-001: Bomb / HRocket — Board Cells Removed, Items Only
Date: 2026-06-04
Status: accepted
...
## Decision
Bomb and H-Rocket are **items only** (player inventory, applied manually). They are NOT placeable as board cells in the stage editor.
...
- Item effects (bomb area, row clear) still chain-react with board state per §5.3.
- Game design §5.2 and §5.3 updated to reflect removal.

## Note
VRocket was part of the original item set but was subsequently removed. See ADR-007.
